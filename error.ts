...
/**
 * This class provides a wrapper for network errors when making requests to Rotten Tomatoes
 */
export class RottenTomatoesError extends Error {
  /**
   * The response body
   */
